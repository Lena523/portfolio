...
export function Globe({ globeConfig, data }: WorldProps) {
  ...
  const startAnimation = useCallback(() => {
    ...
    globeRef.current
      ...
      .arcColor((e: unknown) =>
        typeof e === "object" && e !== null && "color" in e
          ? String((e as { color: string }).color)
          : "#ffffff"
      )
      .arcAltitude((e) => {
    ...
    globeRef.current
      ...
      .pointColor((e: unknown) =>
        typeof e === "object" &&
        e !== null &&
        "color" in e &&
        typeof (e as { color: unknown }).color === "function"
          ? (e as { color: (t: number) => string }).color(0)
          : "#ffffff"
      )
      .pointsMerge(true)
      .pointAltitude(0.0)
